...
import UserMoviesReviewsList from './UserMoviesReviewsList';
...
const UserMoviesReviewsBlock = ({ userId, reviewsCount, title, fullLink }: Props) => {
  return (
    <div className="flex flex-col flex-auto gap-2 border border-gray-200 dark:border-gray-800 rounded-lg p-4">
      ...
      >
        <UserMoviesReviewsList userId={userId} reviewsCount={reviewsCount} height={400} />
      </Suspense>
      {fullLink && (
        <Link
